...
1. [miniconda 다운로드](https://docs.conda.io/en/latest/miniconda.html){:target="_blank"}

2. [microsoft terminal 다운로드](https://apps.microsoft.com/store/detail/windows-terminal/9N0DX20HK701?hl=ko-kr&gl=kr){:target="_blank"}
